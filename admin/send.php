...
<div class="wrapper">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT * from studmsg left join students on students.id=studmsg.student_id1";
                    $query = $conn->query($sql);
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr>
                          <td>".$row['message']."</td>
                          <td>".$row['date_of_mssge']."</td>
                          <td>".$row['student_id']."</td>
                        
                          <td>
                            <button class='btn btn-success btn-sm edit btn-flat' data-id='".$row['message']."'><i class='fa fa-edit'></i> Edit</button>
  ...
  <?php include 'includes/send_modal.php'; ?>
</div>
