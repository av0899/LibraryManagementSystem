          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "  SELECT *, students.student_id AS stud, borrow.status AS barstat,borrow.count as count FROM borrow LEFT JOIN students ON students.id=borrow.student_id  LEFT JOIN books ON books.isbn=borrow.isbn  ORDER BY date_borrow DESC ";
