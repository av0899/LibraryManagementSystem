...
<div class="wrapper">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "  SELECT *, faculty.faculty_id AS stud, borrow1.status AS barstat,borrow1.count as count FROM borrow1 LEFT JOIN faculty ON faculty.id=borrow1.faculty_id  LEFT JOIN books ON books.isbn=borrow1.isbn  ORDER BY date_borrow DESC ";
  ...
  <?php include 'includes/borrow1_modal.php'; ?>
</div>
