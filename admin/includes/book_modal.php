    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="count" class="col-sm-3 control-label">Number of books</label>

                    <div class="col-sm-9">
                      <textarea class="form-control" name="count" id="count" required></textarea>
                    </div>
                </div>
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="count_edit" class="col-sm-3 control-label">Number of Books</label>

                    <div class="col-sm-9">
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="count_edit" name="count">
                      </div>
                    </div>
                </div>
          	</div>
