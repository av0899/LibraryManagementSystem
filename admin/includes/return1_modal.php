    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="return1_add.php">
          		  <div class="form-group">
                  	<label for="faculty" class="col-sm-3 control-label">Faculty ID</label>
                ...
                <div class="form-group">
                    <label for="count1" class="col-sm-3 control-label">Number of books took</label>
                ...
                <div class="form-group">
                    <label for="count" class="col-sm-3 control-label">Number of books Returning</label>
