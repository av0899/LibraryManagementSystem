            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $next=$_SESSION['admin'];
                    $sql = "SELECT *, faculty.faculty_id AS stud FROM return1 LEFT JOIN faculty ON faculty.id=return1.faculty_id LEFT JOIN books ON books.isbn=return1.isbn where faculty.id=$next ORDER BY date_return DESC";
